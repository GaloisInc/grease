...
hpc "${@}" \
  ...
  --hpcdir=${PWD}/dist-newstyle/build/${platform}/ghc-${ghc_ver}/grease-cli-${grease_ver}/x/grease/build/grease/grease-tmp/extra-compilation-artifacts/hpc/vanilla/mix \
  --hpcdir=${PWD}/dist-newstyle/build/${platform}/ghc-${ghc_ver}/grease-cli-${grease_ver}/t/grease-tests/build/grease-tests/grease-tests-tmp/extra-compilation-artifacts/hpc/vanilla/mix \
  --srcdir=grease \
  --srcdir=grease-cli
