...
data BinMd arch
  ...
  -- ^ Map of LLVM-recorded jump-table addresses to their entry counts. This is
  -- not filled in by 'load', it must be filled in separately if desired, e.g.,
  -- using @x86_64LLVMJumpTableSizesFromElf@ from @grease-x86@ .
