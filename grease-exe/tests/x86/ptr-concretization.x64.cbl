; Test pointer concretization modes via symbolic pointer reads (x86-64)
...
(defun @test () Unit
  ...
  (start start:
    ...
    (let val (pointer-read (Bitvector 8) sym-ptr))
...
;; flags {"--entry-addr", "0x1000", "--all-solutions"}
